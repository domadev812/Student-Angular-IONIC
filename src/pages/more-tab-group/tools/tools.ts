...
export class ToolsPage {
  ...
  toolsList = [{name: 'Career Cluster Inventory', url: 'https://utahfutures.org/assessments/career-cluster-traditional', is_mobile: true},
              {name: 'Interest Profiler', url: 'https://www.utahfutures.org/assessments/interest-profiler-traditional', is_mobile: true},
              // tslint:disable-next-line:max-line-length
              {name: 'Reality Check', url: 'https://utahfutures.org/assessments/reality-check;jsessionid=6578B96973A3CCBCC2A6DEA928FB37AC#/budget', is_mobile: true},
              ...
              // tslint:disable-next-line:max-line-length
              {name: 'ACT Prep', url: 'https://www.learningexpresshub.com/productengine/LELIndex.html#/center/learningexpresslibrary/college-preparation-center/home/prepare-for-your-act-test', is_mobile: true},               
              // tslint:disable-next-line:max-line-length
              {name: 'Resume Builder', url: 'http://www.readwritethink.org/files/resources/interactives/resume_generator/', is_mobile: false},                
              {name: 'FAFSA Help', url: 'https://stepuputah.com/paying-for-college/apply-for-financial-aid-fafsa/', is_mobile: true},
